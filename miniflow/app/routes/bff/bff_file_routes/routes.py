...
async def get_file(file_id: str, operations: FileUploadOperations = Depends(get_file_operations), correlation_id: str = Depends(get_current_correlation_id)):
    result = await operations.get_file_upload_record(file_id)
